    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-start w-full gap-2">
          ...
          <div
            className={`${
              file || user?.id ? "border-teriary" : "border-secondary"
            } w-full border rounded-lg px-4 py-[11px] bg-white flex justify-between items-center`}
          >
            <div
              className={`${
        ...
        <div className="flex flex-col items-start w-full gap-2 relative">
          ...
          <div className="w-full relative flex items-center flex-col">
            <div className="w-full">
              ...
              <div
                className={`${
                  position ? "border-teriary" : "border-secondary"
                } bg-white w-full  border rounded-lg p-4 flex justify-between`}
                onClick={(event) => {
